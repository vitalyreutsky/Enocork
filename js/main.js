...
/* harmony import */ var _components_different__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/different */ "./src/js/components/different.js");
/* harmony import */ var _components_different__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_components_different__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony import */ var _components_catalog_menu__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_components_catalog_menu__WEBPACK_IMPORTED_MODULE_4__);
...
/* harmony import */ var _components_dynamic_adapt__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/dynamic-adapt */ "./src/js/components/dynamic-adapt.js");
...
/* harmony import */ var _components_devices__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/devices */ "./src/js/components/devices.js");
/* harmony import */ var _components_devices__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_components_devices__WEBPACK_IMPORTED_MODULE_7__);
...
labels.forEach(label => {
  ...
  if (labelSpan.textContent == "Скидка" || labelSpan.textContent == "Discount") {
    labelStroke.classList.add("product-label-border--red");
    labelSpan.classList.add("product-label-bg--red");
  } else if (labelSpan.textContent == "Акция" || labelSpan.textContent == "Аction") {
    labelStroke.classList.add("product-label-border--green");
    labelSpan.classList.add("product-label-bg--green");
  } else if (labelSpan.textContent == "Хит продаж" || labelSpan.textContent == "Bestseller") {
...
blockInstruction.forEach(block => {
  if (block.classList.contains("product-instruction")) {
    btnInstruction.addEventListener("click", () => {
      ...
      btnInstruction.querySelector(".information-hide__btn").classList.toggle("btnInstructionRotate");
      btnInstruction.querySelector(".information-hide__text").innerHTML = btnInstruction.querySelector(".information-hide__text").innerHTML === "Показать" ? btnInstruction.querySelector(".information-hide__text").innerHTML = "Скрыть" : btnInstruction.querySelector(".information-hide__text").innerHTML = "Показать";
    });
  }
});
...
if (sectionPartners) {
  ...
  const observerPartners = new IntersectionObserver((entries, observer) => {
    ...
    entries.forEach(entry => {
      ...
      const barrel = document.querySelector(".partners-block__animation-image svg");
      if (entry.isIntersecting) {
        // добавить ему CSS-класс
...
//!hero-swiper
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_0__.Keyboard, swiper__WEBPACK_IMPORTED_MODULE_0__.EffectFade]);
...
catalogSliders.forEach(slider => {
  swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_0__.Keyboard]);
  const catalogSliders = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](slider, {
    speed: 700,
    loop: false,
    slidesPerGroup: 1,
    slidesPerView: "auto",
  ...
  if (slides.length <= 3) {
    slider.previousElementSibling.querySelector(".slider-btns").classList.add("hide-swiper-btns");
  }
  if (slides.length == 2) {
    slides.forEach(item => {
      item.style.width = "50%";
  ...
  if (window.innerWidth < 600) {
    ...
    if (slides.length > 1) {
      slider.previousElementSibling.querySelector(".slider-btns").classList.remove("hide-swiper-btns");
    }
  }
});
...
//!menu swiper
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_0__.Keyboard]);
const menuSliders = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".menu", {
  slidesPerView: "auto",
        ...
        item?.addEventListener("click", () => {
          ...
          if (visuallySpanMenu == visuallySpanAccordion) {
            ...
            if (accordionItem.previousElementSibling) {
              accordionItem.previousElementSibling.querySelector(".accordion__header").classList.add("accordion-item-prev--active");
            }
          } else {
            link.classList.remove("accordion-header--active");
            accordionBody.classList.remove("accordion-body--active");
            accordionBody.parentElement.classList.remove("accordion-item--active");
            accordionBody.parentElement.classList.remove("accordion-item-prev--active");
          }
        });
        link.addEventListener("click", () => {
          document.querySelector(".accordion-header--active").classList?.remove("accordion-header--active");
          link.classList?.remove("accordion-header--active");
          link.classList?.toggle("accordion-header--active");
          document.querySelector(".accordion-body--active").classList?.remove("accordion-body--active");
          accordionBody.classList?.remove("accordion-body--active");
          accordionBody.classList?.toggle("accordion-body--active");
          document.querySelector(".accordion-item--active").classList?.remove("accordion-item--active");
          accordionBody.parentElement.classList?.remove("accordion-item--active");
          accordionBody.parentElement.classList?.toggle("accordion-item--active");
          if (accordionItem.previousElementSibling) {
            document.querySelector(".accordion-item-prev--active").classList?.remove("accordion-item-prev--active");
            accordionItem.previousElementSibling.querySelector(".accordion__header").classList?.remove("accordion-item-prev--active");
            accordionItem.previousElementSibling.querySelector(".accordion__header").classList?.toggle("accordion-item-prev--active");
          }
        });
