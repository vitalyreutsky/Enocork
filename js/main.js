    ...
    catalogMenuLink.forEach(link => {
      ...
      if (subMenu.classList.contains("sub-menu--active")) {
        ...
        subMenuItems.forEach(subMenuItem => {
          if (e.target !== link && e.target !== link.parentElement && e.target !== catalogMenu && e.target !== catalogMenu.parentElement && e.target !== link.nextElementSibling && e.target !== subMenu.querySelector(".sub-menu__list") && e.target !== subMenuItem && e.target !== subMenuItem.querySelector(".sub-menu__link")) {
