...
/* harmony import */ var _components_dynamic_adapt__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/dynamic-adapt */ "./src/js/components/dynamic-adapt.js");
...
if (showMore) {
  ...
  showMore.addEventListener("click", () => {
    showMoreText.textContent = showMoreText.textContent === "Показать еще" ? showMoreText.textContent = "Скрыть" : showMoreText.textContent = "Показать еще";
    const arr = Array.from(document.querySelector(".subcategory-products__wrapper").children);
...
if (breakpointMax.matches === true) {
  document.querySelector(".swiper-slide__descr").remove();
